        ...
        <div className="flex md:grid md:grid-cols-3 lg:grid-cols-5 gap-6 overflow-x-auto md:overflow-visible pb-4">
          {doctors.slice(0, 10).map((item, idx) => (
            <div
              ...
              key={idx}
              className="min-w-[250px] md:min-w-0 border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:-translate-y-2 transition-all duration-500 bg-white shadow-sm shrink-0"
            >
              <img
